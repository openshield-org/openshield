...
const siteContent = {
    ...
    rules: [
        ...
        // Serverless (5)
        {"id": "AZ-FUNC-001", "name": "Function App HTTPS Only Disabled", "severity": "HIGH", "category": "Serverless", "description": "The Function App accepts unencrypted HTTP traffic.", "frameworks": {"NIST": "PR.AC-5", "ISO27001": "A.13.1.1", "SOC2": "CC6.6"}},
        {"id": "AZ-FUNC-002", "name": "Function App Minimum TLS Below 1.2", "severity": "HIGH", "category": "Serverless", "description": "The Function App permits TLS older than 1.2.", "frameworks": {"NIST": "PR.AC-5", "ISO27001": "A.13.1.1", "SOC2": "CC6.6"}},
