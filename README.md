...
| Feature | Description |
|---|---|
| **Misconfiguration Scanner** | Runs 65 Azure security rules across storage, network, identity, database, compute, Key Vault, AKS, supply chain, and post-quantum cryptography |
...
| **Remediation Playbooks** | Every rule ships with a matching Azure CLI remediation script (65 playbooks) |
