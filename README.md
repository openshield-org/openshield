...
| Feature | Description |
|---|---|
| **Misconfiguration Scanner** | Runs 106 Azure security rules across storage, network, identity, database, compute, Key Vault, AKS, post-quantum cryptography, backup, serverless, private endpoint, and supply chain posture |
...
| **Remediation Playbooks** | Every rule ships with a matching Azure CLI remediation script (106 playbooks) |
