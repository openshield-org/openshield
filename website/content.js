...
const siteContent = {
    ...
    rules: [
        ...
        // Identity (4)
        {"id": "AZ-IDN-001", "name": "Service Principal Assigned Owner Role at Subscription Scope", "severity": "HIGH", "category": "Identity", "description": "A service principal holds the Owner role at subscription scope, granting it full control over all resources and the ability to assign roles to other principals. This violates the principle of least privilege.", "frameworks": {"CIS": "1.24", "NIST": "PR.AC-4", "ISO27001": "A.9.2.3"}},
        ...
        {"id": "AZ-IDN-004", "name": "No Privileged Identity Management for Admin Roles", "severity": "HIGH", "category": "Identity", "description": "Privileged Identity Management (PIM) is not configured for one or more admin roles in Entra ID. Without PIM, admin roles are permanently assigned with no just-in-time access controls or time-bound activation.", "frameworks": {"CIS": "1.16", "NIST": "PR.AC-4", "ISO27001": "A.9.2.3", "SOC2": "CC6.3"}},
        {"id": "AZ-IDN-005", "name": "Guest User with High Privilege Role in Entra ID", "severity": "HIGH", "category": "Identity", "description": "A guest identity holds a privileged directory role, increasing the impact of external account compromise.", "frameworks": {"CIS": "1.3", "NIST": "PR.AC-4", "ISO27001": "A.9.2.3"}},
        {"id": "AZ-IDN-006", "name": "Service Principal Client Secret Older Than 90 Days", "severity": "HIGH", "category": "Identity", "description": "A service principal credential is older than the approved rotation period.", "frameworks": {"CIS": "1.14", "NIST": "PR.AC-1", "ISO27001": "A.9.4.3"}},
        {"id": "AZ-IDN-007", "name": "Active User with No MFA Registered in Entra ID", "severity": "HIGH", "category": "Identity", "description": "An active member account has no registered multi-factor authentication method.", "frameworks": {"CIS": "1.1", "NIST": "PR.AC-7", "ISO27001": "A.9.4.2"}},
        {"id": "AZ-IDN-008", "name": "Custom RBAC Role with Wildcard Permissions at Subscription Scope", "severity": "HIGH", "category": "Identity", "description": "A custom role grants wildcard permissions at subscription scope and can exceed intended least privilege.", "frameworks": {"CIS": "1.23", "NIST": "PR.AC-4", "ISO27001": "A.9.2.3"}},
        {"id": "AZ-IDN-009", "name": "No Activity Log Alert for Role Assignment Changes", "severity": "MEDIUM", "category": "Identity", "description": "No enabled activity-log alert detects changes to Azure role assignments.", "frameworks": {"CIS": "5.2.1", "NIST": "DE.CM-3", "ISO27001": "A.12.4.1"}},
        {"id": "AZ-IDN-010", "name": "App Registration Has No Owner", "severity": "MEDIUM", "category": "Identity", "description": "The App Registration has no assigned owner. Unowned applications can escape periodic review, credential rotation, permission cleanup, and accountable incident response.", "frameworks": {"NIST": "PR.AC-4", "ISO27001": "A.9.2.1", "SOC2": "CC6.2"}},
        {"id": "AZ-IDN-011", "name": "App Registration Uses Insecure Redirect URI", "severity": "HIGH", "category": "Identity", "description": "The App Registration contains an HTTP redirect URI for a non-loopback host. Authorization responses can be intercepted or modified before reaching the application.", "frameworks": {"NIST": "PR.DS-2", "ISO27001": "A.14.1.2", "SOC2": "CC6.7"}},
        {"id": "AZ-IDN-012", "name": "App Registration Enables OAuth Implicit Grant", "severity": "MEDIUM", "category": "Identity", "description": "The App Registration enables access-token or ID-token issuance through the legacy implicit grant flow. Tokens can be exposed to browser history, extensions, or front-channel leakage.", "frameworks": {"NIST": "PR.AC-3", "ISO27001": "A.9.4.2", "SOC2": "CC6.1"}},
        {"id": "AZ-IDN-013", "name": "App Registration Uses Password Credentials", "severity": "MEDIUM", "category": "Identity", "description": "The App Registration has one or more password credentials. Client secrets are commonly copied, logged, leaked, or left unrotated and are weaker than managed identity or certificate authentication.", "frameworks": {"NIST": "PR.AC-1", "ISO27001": "A.9.4.3", "SOC2": "CC6.1"}},
        {"id": "AZ-IDN-014", "name": "Multi-Tenant App Registration Lacks Property Lock", "severity": "HIGH", "category": "Identity", "description": "The multi-tenant App Registration does not lock all sensitive properties on its service-principal instances. Tenant administrators can modify credentials or token-encryption settings unexpectedly.", "frameworks": {"NIST": "PR.IP-1", "ISO27001": "A.12.1.2", "SOC2": "CC6.6"}},
        {"id": "AZ-IDN-015", "name": "Managed Identity Has Privileged Subscription Role", "severity": "HIGH", "category": "Identity", "description": "A managed identity holds Owner or Contributor at subscription scope. Compromise of any resource that can use the identity would provide an unnecessarily large Azure control-plane blast radius.", "frameworks": {"NIST": "PR.AC-4", "ISO27001": "A.9.2.3", "SOC2": "CC6.3"}},
        // KeyVault (5)
        {"id": "AZ-KV-001", "name": "Key Vault with Soft Delete Disabled", "severity": "MEDIUM", "category": "KeyVault", "description": "Azure Key Vault soft delete is disabled. Without soft delete, secrets, keys, and certificates can be permanently destroyed immediately upon deletion by accident, a disgruntled insider, or an attacker.", "frameworks": {"CIS": "8.8", "NIST": "PR.IP-4", "ISO27001": "A.17.2.1"}},
        ...
        {"id": "AZ-NET-010", "name": "Subnet with No Network Security Group Attached", "severity": "HIGH", "category": "Network", "description": "A subnet exists without a Network Security Group attached. Without an NSG at the subnet level, all resources deployed into that subnet have no network layer access control.", "frameworks": {"CIS": "9.10", "NIST": "SC-7", "ISO27001": "A.13.1.1"}},
        ...
        {"id": "AZ-NET-012", "name": "VNet Flow Logs Not Enabled", "severity": "MEDIUM", "category": "Network", "description": "Neither a VNet flow log nor an existing legacy NSG flow log covers this virtual network. Without flow logs, network traffic is not auditable and attacker movement through the network cannot be reconstructed.", "frameworks": {"CIS": "6.7", "NIST": "DE.CM-1", "ISO27001": "A.12.4.1", "SOC2": "CC7.2"}},
        ...
        {"id": "AZ-NET-014", "name": "VNet Peering Configured Without Gateway Transit Restrictions", "severity": "MEDIUM", "category": "Network", "description": "A Virtual Network peering connection has gateway transit enabled, potentially enabling lateral movement between network zones that should be isolated from each other.", "frameworks": {"CIS": "6.6", "NIST": "PR.AC-5", "ISO27001": "A.13.1.1", "SOC2": "CC6.6"}},
        {"id": "AZ-NET-015", "name": "Public DNS Zone Exposes Internal Infrastructure Details", "severity": "MEDIUM", "category": "Network", "description": "A public DNS zone exposes private RFC1918 addresses or internal-service names that assist infrastructure reconnaissance.", "frameworks": {"CIS": "9.8", "NIST": "PR.AC-5", "ISO27001": "A.13.1.1", "SOC2": "CC6.6"}},
        // Storage (5)
        ...
        {"id": "AZ-PQC-003", "name": "Key Vault Certificate Using Non-Quantum-Safe Signature Algorithm", "severity": "MEDIUM", "category": "PostQuantum", "description": "The Key Vault contains certificates signed using RSA or ECDSA algorithms, vulnerable to Shor's algorithm. Certificates used for TLS, authentication, and code signing will need migration to ML-DSA (FIPS 204) or SLH-DSA (FIPS 205) as certificate authorities add post-quantum support.", "frameworks": {"CIS": "8.9", "NIST": "PR.DS-2", "ISO27001": "A.10.1.2", "SOC2": "CC6.7"}},
        {"id": "AZ-AKS-001", "name": "AKS Private Cluster Not Enabled", "severity": "HIGH", "category": "Kubernetes", "description": "The AKS control-plane API is reachable through a public endpoint.", "frameworks": {"CIS": "N/A-AKS-001", "NIST": "PR.AC-3", "ISO27001": "A.13.1.1"}},
        {"id": "AZ-AKS-002", "name": "AKS Local Accounts Enabled", "severity": "HIGH", "category": "Kubernetes", "description": "Local AKS accounts permit authentication outside centrally governed Entra identities.", "frameworks": {"CIS": "N/A-AKS-002", "NIST": "PR.AC-1", "ISO27001": "A.9.2.1"}},
        {"id": "AZ-AKS-003", "name": "AKS Cluster Not Using Managed Identity", "severity": "HIGH", "category": "Kubernetes", "description": "The AKS control plane does not use an Azure managed identity.", "frameworks": {"CIS": "N/A-AKS-003", "NIST": "PR.AC-1", "ISO27001": "A.9.2.1"}},
        {"id": "AZ-AKS-004", "name": "AKS Workload Identity Not Fully Enabled", "severity": "MEDIUM", "category": "Kubernetes", "description": "OIDC issuer or Workload Identity support is not fully enabled for the cluster.", "frameworks": {"CIS": "N/A-AKS-004", "NIST": "PR.AC-4", "ISO27001": "A.9.2.3"}},
        {"id": "AZ-AKS-005", "name": "AKS Azure Policy Add-on Not Enabled", "severity": "MEDIUM", "category": "Kubernetes", "description": "The cluster does not use the Azure Policy add-on for centralized governance.", "frameworks": {"CIS": "N/A-AKS-005", "NIST": "PR.IP-1", "ISO27001": "A.12.1.2"}},
        {"id": "AZ-AKS-006", "name": "AKS Node OS Automatic Upgrades Disabled", "severity": "HIGH", "category": "Kubernetes", "description": "The cluster lacks a managed node operating-system security upgrade channel.", "frameworks": {"CIS": "N/A-AKS-006", "NIST": "PR.IP-12", "ISO27001": "A.12.6.1"}},
        // Backup (4)
        {"id": "AZ-BAK-001", "name": "Backup Soft Delete Disabled or Below 35 Days", "severity": "CRITICAL", "category": "Backup", "description": "The Recovery Services vault lacks the approved soft-delete recovery window.", "frameworks": {"NIST": "PR.IP-4", "ISO27001": "A.12.3.1", "SOC2": "A1.2"}},
        {"id": "AZ-BAK-002", "name": "Backup Vault Immutability Disabled", "severity": "HIGH", "category": "Backup", "description": "Vault immutability is disabled, allowing destructive changes to protected recovery points.", "frameworks": {"NIST": "PR.IP-4", "ISO27001": "A.12.3.1", "SOC2": "A1.2"}},
        {"id": "AZ-BAK-004", "name": "Backup Multiuser Authorization Missing", "severity": "HIGH", "category": "Backup", "description": "The vault does not enable Resource Guard multiuser authorization.", "frameworks": {"NIST": "PR.AC-4", "ISO27001": "A.9.2.3", "SOC2": "CC6.1"}},
        {"id": "AZ-BAK-006", "name": "Backup Security Monitoring Disabled", "severity": "MEDIUM", "category": "Backup", "description": "The Recovery Services vault does not enable built-in monitoring for backup job failures.", "frameworks": {"NIST": "DE.CM-1", "ISO27001": "A.12.4.1", "SOC2": "CC7.2"}},
        // Serverless (5)
        {"id": "AZ-FUNC-001", "name": "Function App HTTPS Only Disabled", "severity": "HIGH", "category": "Serverless", "description": "The Function App accepts unencrypted HTTP traffic.", "frameworks": {"NIST": "PR.DS-2", "ISO27001": "A.13.2.1", "SOC2": "CC6.6"}},
        {"id": "AZ-FUNC-002", "name": "Function App Minimum TLS Below 1.2", "severity": "HIGH", "category": "Serverless", "description": "The Function App permits TLS older than 1.2.", "frameworks": {"NIST": "PR.DS-2", "ISO27001": "A.13.2.1", "SOC2": "CC6.6"}},
        {"id": "AZ-FUNC-003", "name": "Function App FTP Publishing Enabled", "severity": "MEDIUM", "category": "Serverless", "description": "The Function App exposes an FTP or FTPS deployment channel.", "frameworks": {"NIST": "PR.AC-5", "ISO27001": "A.13.1.1", "SOC2": "CC6.6"}},
        {"id": "AZ-FUNC-004", "name": "Function App Remote Debugging Enabled", "severity": "HIGH", "category": "Serverless", "description": "Remote debugging expands the Function App management attack surface.", "frameworks": {"NIST": "PR.AC-5", "ISO27001": "A.13.1.1", "SOC2": "CC6.6"}},
        {"id": "AZ-FUNC-005", "name": "Function App Managed Identity Missing", "severity": "MEDIUM", "category": "Serverless", "description": "The Function App has no Azure managed identity for secretless resource access.", "frameworks": {"NIST": "PR.AC-5", "ISO27001": "A.13.1.1", "SOC2": "CC6.6"}},
        // Private Endpoint (6)
        {"id": "AZ-PE-001", "name": "Storage Public Network Access Enabled", "severity": "HIGH", "category": "Network", "description": "A Storage Account remains publicly reachable; an approved private endpoint alone does not disable its public endpoint.", "frameworks": {"NIST": "PR.AC-5", "ISO27001": "A.13.1.1", "SOC2": "CC6.6"}},
        {"id": "AZ-PE-002", "name": "Azure SQL Public Network Access Enabled", "severity": "HIGH", "category": "Network", "description": "An Azure SQL logical server remains publicly reachable, regardless of whether a private endpoint also exists.", "frameworks": {"NIST": "PR.AC-5", "ISO27001": "A.13.1.1", "SOC2": "CC6.6"}},
        {"id": "AZ-PE-003", "name": "PostgreSQL Public Network Access Enabled", "severity": "HIGH", "category": "Network", "description": "A PostgreSQL Flexible Server remains publicly reachable instead of using private networking only.", "frameworks": {"NIST": "PR.AC-5", "ISO27001": "A.13.1.1", "SOC2": "CC6.6"}},
        {"id": "AZ-PE-004", "name": "Web or Function App Public Network Access Enabled", "severity": "HIGH", "category": "Network", "description": "An App Service workload remains publicly reachable without a default-deny access policy.", "frameworks": {"NIST": "PR.AC-5", "ISO27001": "A.13.1.1", "SOC2": "CC6.6"}},
        {"id": "AZ-PE-005", "name": "Recovery Vault Public Network Access Enabled", "severity": "HIGH", "category": "Network", "description": "A Recovery Services vault permits public access, even if a private endpoint also exists.", "frameworks": {"NIST": "PR.AC-5", "ISO27001": "A.13.1.1", "SOC2": "CC6.6"}},
        {"id": "AZ-PE-006", "name": "Private Endpoint Connection Not Approved", "severity": "MEDIUM", "category": "Network", "description": "A private endpoint connection is pending, rejected, or disconnected and does not provide an active private path.", "frameworks": {"NIST": "PR.AC-5", "ISO27001": "A.13.1.1", "SOC2": "CC6.6"}}
    ],
    ecosystem: [
        {
            id: "scanner",
